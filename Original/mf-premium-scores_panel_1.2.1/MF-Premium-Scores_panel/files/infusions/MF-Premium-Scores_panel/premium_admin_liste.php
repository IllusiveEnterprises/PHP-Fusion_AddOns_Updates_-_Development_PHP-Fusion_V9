...
if(iADMIN) { 
	$result = dbquery("SELECT * FROM ".DB_mfp_scores." WHERE status='aktiv' ORDER BY bis DESC");
		...
		echo "<tr><td class='tbl2'><b><center>Premium User</b></center></td>";
		echo "<td class='tbl2'><b><center>Zeit</b></center></td></tr>";
...
echo "<br />";
				...
				if (dbrows($result2)) {
					...
					echo "<tr class='tbl2'><td colspan=4><center><b>Premium Kauf</b></center></td></tr>";
