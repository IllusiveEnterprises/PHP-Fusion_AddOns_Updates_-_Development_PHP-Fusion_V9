...
if (isset($_POST['save'])) {
	...
	$pinnwand_sonst1 = stripinput($_POST['pinnwand_sonst1']);
	$result = dbquery("UPDATE ".$db_prefix."d1_pinnwand_system_settings SET	pinnwand_limit='$pinnwand_limit', pinnwand_access='$pinnwand_access', pinnwand_userlimit='$pinnwand_userlimit', pinnwand_scoresh='$pinnwand_scoresh', pinnwand_scores='$pinnwand_scores', pinnwand_pn='$pinnwand_pn', pinnwand_sonst1='$pinnwand_sonst1'");
	...
	echo "<form action='' method='post' name='inputform' onsubmit='return ValidateForm(this);'>
			...
			<td>
				<select name='pinnwand_access' class='textbox'>
					<option value='0' ".($d1_pinnwand_settings['pinnwand_access'] == 0 ? "selected='selected'" : "").">".$locale['user0']."</option> 
					<option value='1' ".($d1_pinnwand_settings['pinnwand_access'] == 1 ? "selected='selected'" : "").">".$locale['user1']."</option>
					</select>
			</td>
			</tr><tr>
			...
			<td nowrap='nowrap'>".$locale['TIBLAP035']."</td>
			<td>
				<select name='pinnwand_sonst1' class='textbox'>
					<option value='0' ".($d1_pinnwand_settings['pinnwand_sonst1'] == 0 ? "selected='selected'" : "").">".$locale['TIBLAP025']."</option>
					<option value='1' ".($d1_pinnwand_settings['pinnwand_sonst1'] == 1 ? "selected='selected'" : "").">".$locale['TIBLAP026']."</option>
					</select>
			</td>
			</tr><tr>
