...
echo "	<option disabled='disabled' value='1'>Scores</option>";
}
...
echo "<td class='tbl1' style='text-align:center;'><a alt='banner' title='banner' href='".INFUSIONS."D1_coupon_panel/D1_coupon_bild.php".$aidlink."&amp;coupon=".$acp['coupon']."' target='_blank'><img style='vertical-align: middle;' border='0' title='banner' src='images/banner.png'></a> | <a alt='l&ouml;schen' title='l&ouml;schen' href='".FUSION_SELF.$aidlink."&amp;section=d1cpadd&delete=".$acp['id']."' onclick=\"return confirm('Coupon -".$acp['coupon']."- wirklich l&ouml;schen ???');\"><img style='vertical-align: middle;' border='0' title='l&ouml;schen' src='images/delete.png'></a></td>";
echo "</tr>";
	}
echo "<tr>";
