...
if (isset($_POST['save_reg'])) {
	...
	$result = dbquery("UPDATE ".DB_D1DW_conf." SET
		...
		site_url = '".$site_url."'
		WHERE conf = '1'");
	redirect(INFUSIONS."D1_dice_to_win_panel/D1_dice_to_win_admin.php".$aidlink);
} else {
...
<center><img src=\"".BASEDIR."infusions/D1_dice_to_win_panel/images/reg.png\" border=\"0\" style=\"vertical-align:middle;\"></center>
</td>
...
<center><img src=\"".BASEDIR."infusions/D1_dice_to_win_panel/images/reg2.png\" border=\"0\" style=\"vertical-align:middle;\"></center>
</td>
</tr></table></center>";
...
echo "<table cellpadding='3' cellspacing='1' width='600px' class='tbl-border center'>
		...
		<tr>
			...
			<td class='tbl1' style='text-align:left;'>
				<a href='http://www.deeone.de/infusions/register_system/MZ_register.php?infid=9&amp;rurl=".$settings['site_host']."' target='_blank'>".$locale['reg06']."</a>
			</td>
		</tr>

				<input type='hidden' class='textbox".$error."' name='inf_name' style='width:250px;' value='".md5("D1 Dice to win")."' />
