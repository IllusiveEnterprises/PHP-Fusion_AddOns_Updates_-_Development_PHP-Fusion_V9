...
mysql_query("INSERT INTO ".DB_d1_tbuser." (`user_id`, `user_name`, `time_von`, `time_bis`, `user_punkte`) VALUES ('".$userdata['user_id']."', '".$userdata['user_name']."', '".time()."', '".$nexttime."', '0');");
}
...
mysql_query("UPDATE ".DB_d1_tbuser." SET user_name = '".$userdata['user_name']."', time_von = '".time()."', time_bis = '".$nexttime."', user_punkte = '".$punkteplus."', user_punkte3 = '".$punkteplus3."' WHERE user_id = '".$userdata['user_id']."' ");
