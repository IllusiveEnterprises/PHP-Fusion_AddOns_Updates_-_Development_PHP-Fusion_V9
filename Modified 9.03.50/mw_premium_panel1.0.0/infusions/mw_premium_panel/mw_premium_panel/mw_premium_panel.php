...
openside($locale['MWP_a040']);
echo "<table width='100%' class='spacer' cellpadding='0' cellspacing='0'>";
if ($aktiv['status'] =='1') {
	echo "<tr><td align='center'><b>".$locale['MWP_a041']." <br /><font color='#00FF00'><img style='vertical-align:middle;' alt='Datum' title='Datum' src=".INFUSIONS."mw_premium_panel/images/datum.png> ".showdate("%d.%m.%Y<br /><img style='vertical-align:middle;' ' alt='Time' title='Time' src=".INFUSIONS."mw_premium_panel/images/time.png> %H:%M:%S &nbsp;&nbsp;&nbsp;", $aktiv['time_off'])."</font><br />".$locale['MWP_a042']." </b><br /><br /><a class='button' title='Verl&auml;ngern' href='".INFUSIONS."mw_premium_panel/mw_premium.php'>".$locale['MWP_a043']."</a></td></tr>";
} elseif ($aktiv['status'] =='0') {
	echo "<tr><td align='center'><font color='red'><b>".$locale['MWP_a044']."t<br />".$locale['MWP_a045']."</b></font><br /><br /><a class='button' title='Premium aktivieren' href='".INFUSIONS."mw_premium_panel/mw_premium.php'>".$locale['MWP_a046']."</a></td></font></tr>";
} elseif ($aktiv['status'] =='') {
	echo "<tr><td align='center'><a href='".INFUSIONS."mw_premium_panel/mw_premium.php'><font color='#2992C0'><b>".$locale['MWP_a047']."</b></font></a></td></tr>";
}
echo"</table>";
closeside();
?>