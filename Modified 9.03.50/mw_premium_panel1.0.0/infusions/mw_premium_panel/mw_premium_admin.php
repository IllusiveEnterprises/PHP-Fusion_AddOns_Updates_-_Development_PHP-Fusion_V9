...
///Version ende
*/
opentable($locale['MWP_title']);
	echo "<table cellpadding='0' cellspacing='0' class='tbl-border center' style='margin:0 auto; width:100%;'>";
	echo "<tr>";
	echo "<td width='25%' class='".($section == "status" ? "tbl1" : "tbl2")."' align='center'>".($section == "status" ? "<strong>".$locale['MWP_a001']."</strong>" : "<a href='".FUSION_SELF.$aidlink."&section=status'><strong>".$locale['MWP_a001']."</strong></a>")."</td>";
	echo "<td width='25%' class='".($section == "settings" ? "tbl1" : "tbl2")."' align='center'>".($section == "settings" ? "<strong>".$locale['MWP_a002']."</strong>" : "<a href='".FUSION_SELF.$aidlink."&section=settings'><strong>".$locale['MWP_a002']."</strong></a>")."</td>";
	echo "<td width='25%' class='".($section == "pack" ? "tbl1" : "tbl2")."' align='center'>".($section == "pack" ? "<strong>".$locale['MWP_a003']."</strong>" : "<a href='".FUSION_SELF.$aidlink."&section=pack'><strong>".$locale['MWP_a003']."</strong></a>")."</td>";
	echo "<td width='25%' class='tbl2' align='center'><a href='".INFUSIONS."mw_premium_panel/mw_premium.php'><strong>".$locale['MWP_a004']."</strong></a></td>";
	echo "</tr></table><br />";
...
switch ($section) {
	...
	echo "<tr><td class='tbl2' colspan='2' style='font-weight:bold;text-align:center;'>".$locale['MWP_a031']."</td></tr>";
	...
	echo "<select name='ptime' id='ptime' style='margin-right:5px;'>
		...
		<option value='60'>".$locale['MWP_a010']."</option>
		<option value='3600'>".$locale['MWP_a011']."</option>
		<option value='86400'>".$locale['MWP_a012']."</option>
		<option value='604800'>".$locale['MWP_a013']."</option>
		<option value='2592000'>".$locale['MWP_a014']."</option>
		<option value='31536000'>".$locale['MWP_a015']."</option>
		</select>";
	echo "<input type='submit' name='premium_saved' value='".$locale['MWP_a016']."' class='button' />";
	echo "</td></tr></table></form>";
	echo "<br />";
	// Premium Mitglieder Liste
	echo "<table width='100%' class='tbl-border' cellpadding='0' cellspacing='0' align='center'>";
	echo "<tr><td class='tbl2' colspan='9' style='font-weight:bold;text-align:center;'>".$locale['MWP_a001']."</td></tr>";
	echo "<tr><td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a001']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a006']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a007']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a008']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$score_settings['set_units']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a017']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a018']."</td>";
	echo "<td class='tbl1' style='font-weight:bold;text-align:center;'>".$locale['MWP_a019']."</td></tr>";
	...
	if (dbrows($result)) {
		...
		echo "<tr><td class='tbl2' colspan='9' style='font-weight:bold;text-align:center;'>".$locale['MWP_a009']."</td></tr>";
	}
	echo "</table>";
	...
	echo "<table width='60%' class='tbl-border' cellpadding='0' cellspacing='0' align='center'>";
	echo "<tr><td class='tbl2' colspan='2' style='font-weight:bold;text-align:left;'>".$locale['MWP_a020']."</td></tr>";
	echo "<tr>";
	echo "<td class='tbl1' style='text-align:right;' width='40%'>".$locale['MWP_a021']."</td>";
	echo "<td class='tbl1' style='text-align:left;'>";
	echo "<select name='premium_group'>";
	echo "<option value='0'>".$locale['MWP_a022']."</option>";
	...
	echo "</select></td></tr>";
	echo "<tr><td class='tbl2' style='text-align:center;' colspan='2'><input type='submit' name='save' value='".$locale['MWP_a016']."' class='button' />";
	echo "</td></tr></table></form>";
	break;
	...
	echo "<tr><td class='tbl1' colspan='4' style='font-weight:bold;font-size:bigger;text-align:center;'>".$locale['MWP_a030']."</td></tr>";
	echo "<tr><td class='tbl2' width='39%' style='font-weight:bold;'>".$locale['MWP_a031']."</td>";
	echo "<td class='tbl2' width='39%' style='font-weight:bold;'>".$locale['MWP_a032']."</td>";
	echo "<td class='tbl2' width='20%' style='font-weight:bold;'>".$locale['MWP_a033']."</td></tr>";
	if (dbrows($result) != 0) {
		$i = 0;
		while ($pack = dbarray($result)) {
			...
			echo "<td class='".$class."' style='text-align:center;'><a href='".FUSION_SELF.$aidlink."&section=pack&deletepack=true&pack_id=".$pack['pack_id']."'><img src='".INFUSIONS."mw_premium_panel/images/delete.png' alt='delete' title='".$locale['MWP_a019']." style='width:16px; height:16px; vertical-align:middle;' border='0' /></a>";
			echo "</td></tr>";
			$i++;
		}
	} else {
		echo "<tr><td class='tbl1' colspan='8'>".$locale['MWP_a033']."</td></tr>";
	}
	echo "<tr><td class='tbl2' colspan='8' style='font-weight:bold;font-size:bigger;text-align:center;'><a href='".FUSION_SELF.$aidlink."&section=pack&newpack=true' class='button'>".$locale['MWP_a035']."</a></td></tr>";
	echo "</table>";
	...
	if (isset($_GET['newpack'])) {
		if (isset($_POST['pack_saved'])) {
			...
			<tr>
			<td class='tbl1' colspan='2' style='font-weight:bold;font-size:bigger;text-align:left;'>".$locale['MWP_a035'].":</td>
			</tr>
			<tr>
			<td class='tbl2' style='vertical-align:top;text-align:right;'><label for='pack_time'>".$locale['MWP_a031'].":</label></td>
			...
			<td class='tbl2' style='vertical-align:top;text-align:right;'><label for='pack_price'>".$locale['MWP_a032'].":</label></td>
			...
			<tr>
			<td class='tbl2' style='vertical-align:top;text-align:center;' colspan='2'><input type='submit' name='pack_saved' value='".$locale['MWP_a016']."' class='button' />&nbsp;<input type='reset' value='Reset' class='button' /></td>
			</tr>
			</table>
			</form>";
		}
