...
$inf_insertdbrow[] = DB_D1CP_conf." SET conf = '1', coupon_scores = 'Scores', coupon_errinfo = '1', inf_name = '', site_url = '' ";
$inf_insertdbrow[] = DB_PANELS." SET panel_name='".$inf_panel."', panel_filename='".$inf_folder."', panel_side=4, panel_order='5', panel_type='file', panel_access='-101', panel_display='0', panel_status='1' ";

//$inf_insertdbrow[3] = DB_D1CP." (id, coupon, timestart, timeend, scores) VALUES('1', 'TEST2012', '1340193333', '1341193333', '10')";

$inf_droptable[] = DB_D1CP_conf;
