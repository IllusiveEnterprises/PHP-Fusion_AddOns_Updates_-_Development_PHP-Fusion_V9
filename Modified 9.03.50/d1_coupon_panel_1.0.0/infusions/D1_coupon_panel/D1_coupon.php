...
| Copyright (C) 2002 - 20011 Nick Jones
...
$result = dbquery("UPDATE ".DB_USERS." SET  `user_groups` =  '".str_replace(".".$mfpssettings['prem_gruppe']."", "", $userdata['user_groups']).".".$mfpssettings['prem_gruppe']."' WHERE  `user_id` = ".$usercp_id.";");
}
