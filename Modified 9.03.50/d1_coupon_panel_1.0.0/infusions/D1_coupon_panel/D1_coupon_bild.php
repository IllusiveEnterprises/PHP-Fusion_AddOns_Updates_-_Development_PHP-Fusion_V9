...
if ($d1cpcouponsb['sonstiges'] == "1") {
	...
	$imageaddb = $locale['D1CP_admin_030e'];
} elseif ($d1cpcouponsb['sonstiges'] == "2") {
	$typeaddb = $locale['D1CP_admin_029'];
	$imageaddb = $locale['D1CP_admin_030f'];
} elseif ($d1cpcouponsb['sonstiges'] == "3") {
	$typeaddb = $locale['D1CP_admin_030'] ;
	$imageaddb = $locale['D1CP_admin_030f'];
} else {
	$typeaddb = "ERROR";
	$imageaddb = "ERROR";
...
ImageString ($bild, $textnr5, 10, 47, $locale['D1CP_admin_030g']. $cstart.$locale['D1CP_admin_030h'].$cend, $text_farbe5);
} /*else {
$textnr = 5;
$bild = imagecreate (268 , 60);
imagecolorallocate ($bild, 255, 255, 255);
