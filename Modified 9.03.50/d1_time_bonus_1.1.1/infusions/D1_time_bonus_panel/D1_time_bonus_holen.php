...
mysql_query("INSERT INTO ".DB_d1_tbuser." (`user_id`, `user_name`, `time2_von`, `time2_bis`, `user_punkte`) VALUES ('".$userdata['user_id']."', '".$userdata['user_name']."', '".time()."', '".$nexttime2."', '0');");
	...
	$result = dbquery("UPDATE ".DB_d1_tbuser." SET user_name = '".$userdata['user_name']."', time2_von = '".time()."', time2_bis = '".$nexttime2."', user_punkte = '".$punkteplus."', user_punkte2 = '".$punkteplus2."' WHERE user_id = '".$userdata['user_id']."' ");
