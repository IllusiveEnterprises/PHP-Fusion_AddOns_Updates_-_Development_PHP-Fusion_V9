...
if(isset($_POST['premium_saved'])) {
	...
	include("./msg.php");
    $result = dbquery("INSERT INTO ".DB_MESSAGES." (`message_id`, `message_to`,  `message_user`, `message_from`, `message_subject`, `message_message`, `message_smileys`, `message_read`, `message_datestamp`, `message_folder`) VALUES (NULL, '".$user_id."', '".$user_id."','1', '".$gif_user."', '".$nachricht_10."', 'y', '0', '".time()."', '0');");
...
$result = dbquery("UPDATE ".DB_USERS." SET  `user_groups` =  '".str_replace(".".$mfpssettings['prem_gruppe']."", "", $group['user_groups']).".".$mfpssettings['prem_gruppe']."' WHERE  `user_id` = ".$user_id.";");
		redirect(FUSION_SELF.$aidlink."&section=premiumuser&premiumsuccess=true");
...
$result = dbquery("UPDATE ".DB_USERS." SET  `user_groups` =  '".str_replace(".".$mfpssettings['prem_gruppe']."", "", $group['user_groups']).".".$mfpssettings['prem_gruppe']."' WHERE  `user_id` = ".$user_id.";");
	...
	$group = dbarray(dbquery("SELECT * FROM ".DB_USERS." WHERE user_id=".$user_id.""));
$result = dbquery("UPDATE ".DB_USERS." SET  `user_groups` =  '".str_replace(".".$mfpssettings['prem_gruppe']."", "", $group['user_groups'])."' WHERE  `user_id` = ".$user_id.";");
...
<td class='tbl1' style='text-align:left;'>
		...
		<option value='0'>".$locale['MFP_admin_025f']."</option>";
...
echo "
	...
	<tr>
		...
		<option value='86400'".($mfpssettings['prem_s_zeit'] == 86400 ? " selected" : "").">1 ".$locale['MFP_admin_025g']."</option>
		<option value='172800'".($mfpssettings['prem_s_zeit'] == 172800 ? " selected" : "").">2 ".$locale['MFP_admin_025a']."</option>
		<option value='259200'".($mfpssettings['prem_s_zeit'] == 259200 ? " selected" : "").">3 ".$locale['MFP_admin_025a']."</option>
		<option value='345600'".($mfpssettings['prem_s_zeit'] == 345600 ? " selected" : "").">4 ".$locale['MFP_admin_025a']."</option>
		<option value='432000'".($mfpssettings['prem_s_zeit'] == 432000 ? " selected" : "").">5 ".$locale['MFP_admin_025a']."</option>
		<option value='518400'".($mfpssettings['prem_s_zeit'] == 518400 ? " selected" : "").">6 ".$locale['MFP_admin_025a']."</option>
		<option value='604800'".($mfpssettings['prem_s_zeit'] == 604800 ? " selected" : "").">7 ".$locale['MFP_admin_025a']."</option>
		</select>
	</td>
	</tr>";
	echo "
	...
	<tr>
		...
		<option value='604800'".($mfpssettings['prem_m_zeit'] == 604800 ? " selected" : "").">7 ".$locale['MFP_admin_025a']."</option>
		<option value='1209600'".($mfpssettings['prem_m_zeit'] == 1209600 ? " selected" : "").">14 ".$locale['MFP_admin_025a']."</option>
		<option value='1814400'".($mfpssettings['prem_m_zeit'] == 1814400 ? " selected" : "").">21 ".$locale['MFP_admin_025a']."</option>
		<option value='2592000'".($mfpssettings['prem_m_zeit'] == 2592000 ? " selected" : "").">30 ".$locale['MFP_admin_025a']."</option>
		</select>
	</td>
	</tr>";
	echo "
	...
	<tr>
		...
		<option value='2592000'".($mfpssettings['prem_l_zeit'] == 2592000 ? " selected" : "").">30 ".$locale['MFP_admin_025a']."</option>
		<option value='5184000'".($mfpssettings['prem_l_zeit'] == 5184000 ? " selected" : "").">60 ".$locale['MFP_admin_025a']."</option>
		<option value='7776000'".($mfpssettings['prem_l_zeit'] == 7776000 ? " selected" : "").">90 ".$locale['MFP_admin_025a']."</option>
		<option value='10368000'".($mfpssettings['prem_l_zeit'] == 10368000 ? " selected" : "").">120 ".$locale['MFP_admin_025a']."</option>		
		</select>
	</td>
	</tr>";
	echo "
...
echo "<table width='60%' class='tbl-border' cellpadding='0' cellspacing='0' align='center'>
	<tr>
		...
		<tr>
			...
			$userlist .= "<option value='".$data['user_id']."'>".$data['user_name']."</option>\n";
                ...
                $result = dbquery("SELECT * FROM ".DB_mfp_scores." WHERE user_id=".$data['user_id']."");
                $usersettings = dbarray($result);
                $until = intval($usersettings['bis']);
            }
    echo "
	...
	<tr>
		<td class='tbl1' style='text-align:right;' width='40%'>".$locale['MFP_admin_025e'].":</td>
		<td class='tbl1' style='text-align:left;'>
		...
		<option value='0'".($until == 0 ? "' selected '" : "").">---</option>
		<option value='".(3600*24)."'".($until == 86400 ? " selected" : "").">24 ".$locale['MFP_admin_025b']."</option>
		<option value='".(86400*3)."'".($until == 259200 ? " selected" : "").">3 ".$locale['MFP_admin_025a']."</option>
		<option value='".(86400*5)."'".($until == 432000 ? " selected" : "").">5 ".$locale['MFP_admin_025a']."</option>
		<option value='".(86400*7)."'".($until== 604800 ? " selected" : "").">7 ".$locale['MFP_admin_025a']."</option>
		<option value='".(604800*2)."'".($until == 1209600 ? " selected" : "").">2 ".$locale['MFP_admin_025c']." (14d)</option>
		<option value='".(604800*3)."'".($until == 1814400 ? " selected" : "").">3 ".$locale['MFP_admin_025c']." (21d)</option>
		<option value='".(604800*4)."'".($until== 2419200 ? " selected" : "").">4 ".$locale['MFP_admin_025c']." (28d)</option>
		<option value='".(2419200*3)."'".($until == 7257600 ? " selected" : "").">3 ".$locale['MFP_admin_025d']." (84d)</option>
		<option value='".(2419200*6)."'".($until== 14515200 ? " selected" : "").">6 ".$locale['MFP_admin_025d']." (168d)</option>
		<option value='".(2419200*12)."'".($until == 29030400 ? " selected" : "").">12 ".$locale['MFP_admin_025d']." (336d)</option>
		</select>
	</td>
	</tr>";
