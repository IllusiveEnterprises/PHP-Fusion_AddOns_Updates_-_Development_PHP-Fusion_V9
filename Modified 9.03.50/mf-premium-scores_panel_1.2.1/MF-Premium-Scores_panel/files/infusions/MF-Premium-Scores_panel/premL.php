...
} else { echo "<center><span style='color: red;'><b>".$locale['MFP_admin_024i']."</b><br />(".$locale['MFP_admin_024j'].$mfpssettings['prem_l_preis'].$locale['MFP_admin_024k'].")</span></center><br><br><a href=premium_wahl.php>".$locale['MFP_admin_024l']."</a>"; }
}
closetable();
